...
<head>
    ...
    <title>WAM Blog Â· Stories Worth Your Time</title>
    <meta name="description" content="A quiet journal of the craft â€” essays and stories on writing, building, and the ideas we keep coming back to. No noise, no clickbait, just reading worth slowing down for.">
    ...
    <meta property="og:title" content="WAM Blog â€” Stories Worth Your Time">
    <meta property="og:description" content="A quiet journal of the craft â€” essays on writing, building, and the ideas we keep coming back to.">
...
<body>
    ...
    <section class="hero">
        <div class="hero-inner">
            ...
            <p>Carefully written stories on the craft of writing, building, and thinking. No noise, no distractions â€” just good writing that earns your attention.</p>
            ...
            <?php if (empty($posts)): ?>
                <div class="empty-state">
                    ...
                    <?php else: ?>
                        ...
                        <p>Stories are taking shape behind the scenes. Come back soon â€” or sign in and start writing your own.</p>
            ...
            <?php else: ?>
                ...
                <?php if ($totalPages > 1): ?>
                    <div class="pagination">
                        <a class="page-link <?php echo $page <= 1 ? 'disabled' : ''; ?>" href="?page=<?php echo $page - 1; ?>&search=<?php echo urlencode($search); ?>&category=<?php echo $categoryId; ?>">â† Prev</a>
                        ...
                        <?php endfor; ?>
                        <a class="page-link <?php echo $page >= $totalPages ? 'disabled' : ''; ?>" href="?page=<?php echo $page + 1; ?>&search=<?php echo urlencode($search); ?>&category=<?php echo $categoryId; ?>">Next â†’</a>
                    </div>
                <?php endif; ?>
            <?php endif; ?>
        </div>
    ...
    <section id="about" class="about">
        <div class="about-inner">
            ...
            <blockquote>In a world of endless scrolling and clickbait, we believe in the power of thoughtful writing. Every piece here is crafted with care â€” written and built to inform, inspire, and linger a little longer than a feed post.</blockquote>
            <p class="attribution">â€” The WAM editors</p>
        </div>
    </section>
